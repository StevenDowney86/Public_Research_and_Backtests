...
fundamentals['Ratio_Comp_YoY_Earn_Rate_vs_Sector'] = \
    fundamentals['Company_YoY_NetInc_Growth']/ fundamentals\
        ['Sector YoY Earnings Average']
fundamentals['Ratio_Comp_YoY_Earn_Rate_vs_Sector'] = \
    fundamentals['Ratio_Comp_YoY_Earn_Rate_vs_Sector']
...
fundamentals['Ratio_Comp_YoY_Reve_Rate_vs_Sector'] = \
    fundamentals['Company_YoY_Revenue_Growth']/ fundamentals\
        ['Sector YoY Revenue Average']
fundamentals['Ratio_Comp_YoY_Reve_Rate_vs_Sector'] = \
    fundamentals['Ratio_Comp_YoY_Reve_Rate_vs_Sector']
...
#create a 4 month lag as 4 quarters ago fundamentals are all we
#have to forecast next full years earnings
...
OOS_labels = np.array(features['fcf'])
# Remove the labels from the feature and the date
# axis 1 refers to the columns
OOS_features_array = features.drop(['fcf', 'calendardate'], axis = 1)
...
Sector_R2_score = 'OOS R^2 Score PFCF'+test_sector
...
Sector_MAE = 'OOS MAE PFCF'+test_sector
...
features_2 = fundamentals_2[['calendardate', 'fcf',
                             'ticker',
                             'price',
                             'marketcap',
                             'netinc_lag',
...
#forecasted_12mo_FCF
forecasted_12mo_FCF = pd.Series(forecasted_values, name='12 Mo Forecast FCF')

features_3 = features_3.reset_index()

features_4 = pd.concat((features_3, forecasted_12mo_FCF), axis=1, join='inner')

#create forward FCF/P
features_4['Forward FCF/P'] = features_4['12 Mo Forecast FCF']/ \
...
output_name = path_to_file + test_sector + '_OOS_PFCF_Predictions.csv'
